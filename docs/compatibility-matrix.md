...
| compile | 完成 | PoC (Main.ls) | - | Rust | L# parity test 全 PASS | selfhost/Main.ls | - |
...
| lsp | 完成 | PoC (JsonRpc.ls) | - | Rust | L# parity test 全 PASS | selfhost/JsonRpc.ls | - |
| fmt | 完成 | PoC (Formatter.ls) | - | Rust | L# parity test 全 PASS | selfhost/Formatter.ls | - |
...
| Feature | Rust source | L# source | Parity test | Default path | Deletion gate | Evidence | Notes |
|---------|-------------|-----------|-------------|--------------|---------------|----------|-------|
| Lexer | 完成 | 部分実装 (75%) | E2E 6件 | Rust | L# parity test 全 PASS | e2e.rs | - |
| Parser | 完成 | 部分実装 (65%) | E2E 4件 | Rust | L# parity test 全 PASS | e2e.rs | - |
| MacroExpand | 完成 | 部分実装 (35%) -- E2E 5件は通常テスト化済み | E2E 5件 PASS | Rust | L# parity test 全 PASS | e2e.rs | - |
| TypeInfer | 完成 | 部分実装 (45%) -- stale ignore を解消、backend 制約は一部残存 | E2E 7件 PASS | Rust | L# parity test 全 PASS | e2e.rs | - |
| Lower/Compiler | 完成 | 部分実装 (70%) | E2E 2件 | Rust | L# parity test 全 PASS | e2e.rs | - |
