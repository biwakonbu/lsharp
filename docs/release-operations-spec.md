...
- **P11-4** ツールチェイン parity (docs/toolchain-parity-spec.md)
- **P11-5** 互換マトリクス (docs/compatibility-matrix.md)
...
8. post-release
   ...
   - 互換表 (compatibility-matrix.md) を更新
```
...
| 配置先 | 内容 |
|--------|------|
| `docs/compatibility-matrix.md` | 最新版の互換マトリクス (開発用) |
