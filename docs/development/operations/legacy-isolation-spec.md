...
- **P11-3** コンパイラ中核の Rust parity (docs/development/planning/rust-parity-spec.md)
- **P11-5** 差分判定規則 (docs/development/planning/gap-classification.md)
...
- ../planning/compatibility-matrix.md の対応行が「L# parity test 全 PASS」を達成
...
feature parity 完了単位で削除する。削除単位は ../planning/compatibility-matrix.md の行に対応する。
...
| ../planning/compatibility-matrix.md 更新済み | 手動確認 |
...
4. ../planning/compatibility-matrix.md の Deletion gate を「削除済み」に更新
5. TODO.md に削除完了を記録
...
| **deletion gate** | Rust 実装を削除可能になる条件。../planning/compatibility-matrix.md で管理 |
