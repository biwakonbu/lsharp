...
fail-closed boundaryを `test_e2e_selfhost_evidence_registry_consumes_parser_form` と registry focused 11件で
確認した。sampling では負の seed / shrink 値を `invalid-sampling` code `11` とそれぞれの field で拒否し、
