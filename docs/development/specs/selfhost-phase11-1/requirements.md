...
- **FR-002**: `docs/development/planning/compatibility-matrix.md` に、Phase 11 完了まで PR ごとの更新が必須である旨を明記する
...
- **AC-002**: `docs/development/planning/compatibility-matrix.md` に PR 更新ルールが追記されていること
...
- [設計書](design.md)
- [互換性マトリクス](../../planning/compatibility-matrix.md)
