...
- **NFR-CONS-001**: 既存の仕様固定パターン (`docs/language/native-backend-spec.md`, `docs/language/runtime-spec.md` 等) と同じフォーマットを踏襲する
...
- **AC-008**: `docs/development/operations/ci-migration-spec.md` が作成され、P11-6/6a の全タスクをカバーしている
- **AC-009**: `docs/development/operations/legacy-isolation-spec.md` が作成され、P11-6b の全タスクをカバーしている
- **AC-010**: `docs/development/operations/release-operations-spec.md` が作成され、P11-6c の全タスクをカバーしている
- **AC-011**: `docs/development/operations/final-removal-spec.md` が作成され、P11-6d の全タスクをカバーしている
