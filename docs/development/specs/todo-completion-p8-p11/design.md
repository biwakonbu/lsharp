...
| 仕様書 | カバー範囲 |
|--------|-----------|
| `docs/development/operations/ci-migration-spec.md` | P11-6 (5 件) + P11-6a (4 件) |
| `docs/development/operations/legacy-isolation-spec.md` | P11-6b (4 件) |
| `docs/development/operations/release-operations-spec.md` | P11-6c (4 件) |
| `docs/development/operations/final-removal-spec.md` | P11-6d (3 件) |
...
- `docs/development/operations/ci-migration-spec.md` (16,732 bytes)
- `docs/development/operations/legacy-isolation-spec.md` (11,381 bytes)
- `docs/development/operations/release-operations-spec.md` (16,744 bytes)
- `docs/development/operations/final-removal-spec.md` (7,875 bytes)
...
- [CI 移行仕様](../../operations/ci-migration-spec.md)
- [legacy 隔離仕様](../../operations/legacy-isolation-spec.md)
- [リリース運用仕様](../../operations/release-operations-spec.md)
- [最終撤去仕様](../../operations/final-removal-spec.md)
