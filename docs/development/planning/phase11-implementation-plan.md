...
- Current state: `selfhost/src/Backend/Native/` 配下のコード、`test_e2e_native_self_regeneration_functional_equivalence`、`test_e2e_native_stage_chain_structure`、`test_native_pipeline_complete_chain`、`test_native_codegen_emit_standalone_execution`、`test_native_codegen_real_execution`、`test_native_codegen_emits_full_const_instruction_bytes` により native module skeleton / execution slice / structural parity は保持されている。加えて canonical artifact contract / response file text / bundle summary / stage observation determinism / host-side proxy compare loop / proxy artifact materialization (`scripts/ci/build-native.sh`, `test_e2e_native_host_bundle_artifact_writer_materializes_canonical_files`) と representative build entry の `actual-stage23-gap.json` blocker report (`test_e2e_native_actual_stage23_gap_report_for_representative_entry`) までは追加済みで、さらに `LocalGet` / `LocalSet` の stack-slot emit と host local roundtrip (`test_e2e_native_host_binary_local_roundtrip_link_and_execute`)、i32 arithmetic core (`I32Const`, `I32Add`, `I32Mul`, `I32WrapI64`, `I64ExtendI32S`, `I64ExtendI32U`) の emit (`test_e2e_native_host_binary_i32_add_link_and_execute`, `test_e2e_native_host_binary_i32_mul_link_and_execute`, `test_native_codegen_emits_x86_i32_core_instruction_bytes`, `test_native_codegen_emits_x86_i32_mul_bytes`) まで進んだ。`Drop` も `test_e2e_native_host_binary_drop_restores_previous_value`、`test_e2e_native_host_binary_direct_call_arg_drop_restores_previous_value`、`test_e2e_native_host_binary_direct_call_two_arg_drop_restores_spilled_previous`、`test_e2e_native_host_binary_three_value_double_drop_restores_bottom_value` で limited restore path は固定済み。さらに `emit-native-bundle` により direct intra-bundle no-arg call と AArch64 の `fp/lr` save/restore を伴う call-frame の最小 slice を `test_e2e_native_host_binary_direct_call_bundle_link_and_execute`、`test_native_codegen_emits_x86_direct_call_bundle_bytes`、`test_native_codegen_emits_aarch64_direct_call_bundle_bytes` で固定し、`emit-native-function-meta-bundle` により function-meta (`[param-count, local-count, ir]`) を受ける 1-arg / 2-arg / 3-arg / 4-arg / 5-arg / 6-arg / 7-arg / 8-arg / 9-arg / 10-arg / 11-arg / 12-arg / 13-arg / 14-arg / 15-arg / 16-arg / 17-arg / 18-arg / 19-arg direct call を `test_e2e_native_host_binary_direct_call_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_two_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_three_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_four_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_five_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_six_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_seven_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_eight_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_nine_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_ten_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_eleven_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_twelve_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_thirteen_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_fourteen_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_fifteen_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_sixteen_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_seventeen_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_eighteen_arg_bundle_link_and_execute`、`test_e2e_native_host_binary_direct_call_nineteen_arg_bundle_link_and_execute`、`test_native_codegen_emits_x86_direct_call_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_two_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_three_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_four_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_five_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_six_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_seven_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_eight_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_nine_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_ten_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_eleven_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_twelve_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_thirteen_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_fourteen_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_fifteen_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_sixteen_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_seventeen_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_eighteen_arg_bundle_bytes`、`test_native_codegen_emits_x86_direct_call_nineteen_arg_bundle_bytes` で固定した。1-arg call では x86_64 `push/pop rcx`、AArch64 `x10` 退避により single previous-value preservation を追加済みで、さらに two-spill / three-spill / four-spill / five-spill / six-spill / seven-spill / eight-spill / nine-spill / ten-spill / eleven-spill / twelve-spill / thirteen-spill / fourteen-spill / fifteen-spill / sixteen-spill / seventeen-spill value window により 4-arg / 5-arg / 6-arg / 7-arg / 8-arg / 9-arg / 10-arg / 11-arg / 12-arg / 13-arg / 14-arg / 15-arg / 16-arg / 17-arg / 18-arg / 19-arg marshaling まで入った。**ただし** true stage1-native -> stage2-native -> stage3-native の実バイナリ再生成・実行比較は未達で、残主要 blocker は representative `Call`（20+ args・import/runtime 境界・seventeen-spill 19-value window を超える wider stack preservation・実 LoweredModule function plumbing）、representative producer 全面の `Drop`、`I32Store`、`I32Load`、`I64Load/Store`、control-flow / memory ops 群。
- Rust source: `docs/language/native-backend-spec.md`, `docs/development/planning/completion-criteria.md`
