...
その結果 `actual-stage23-gap.json` の先頭 blocker は引き続き representative `Call`、`Drop`、integer logic/compare/data ops（`I32And/Or`, `I32Load(8U)/Store`, `I64Load/Store`, `I64Mul/Div/Rem`, `I64Eq/GeS/GtS/LeS/LtS`）、および control-flow / memory ops（`BlockEmpty`, `Br`, `BrIf`, `Else`, `End`, `If`, `IfEmpty`, `Loop`, `LoopEmpty`, `MemoryCopy`, `MemoryFill`）である。
