...
として parse し、kind mismatch、不正 wire、存在しない node は directive span を含む
fail-closed diagnostic として拒否する。
...
- `source_adapter_reports_malformed_edge_id_with_directive_span`
