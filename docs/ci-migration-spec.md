...
6. **ドキュメント整合**: README, docs/CI.md, CLAUDE.md が L# ベースの手順に更新されている
...
## 関連仕様
- [検証と固定点 仕様 (P11-2d)](verification-spec.md) -- テスト分類、固定点検証の詳細
- [Native Backend 仕様 (v1)](native-backend-spec.md) -- native binary の ABI、codegen 仕様
