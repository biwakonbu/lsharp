...
;; 現状の partial slice では 12-value window ぶんまで spill slot を確保する
                    ...
                    (if (>= current-depth 3) 18 11)
                     (if (= target-param-count 1)
                       10
                        5)))))))))))))
    (if (= opcode 3)
      (if (>= current-depth 11) 141 (if (>= current-depth 10) 127 (if (>= current-depth 9) 113 (if (>= current-depth 8) 99 (if (>= current-depth 7) 85 (if (>= current-depth 6) 71 (if (>= current-depth 5) 57 (if (>= current-depth 4) 43 (if (>= current-depth 3) 29 (if (>= current-depth 2) 15 8))))))))))
      (if (= opcode 10)
        (if (>= current-depth 11) 143 (if (>= current-depth 10) 129 (if (>= current-depth 9) 115 (if (>= current-depth 8) 101 (if (>= current-depth 7) 87 (if (>= current-depth 6) 73 (if (>= current-depth 5) 59 (if (>= current-depth 4) 45 (if (>= current-depth 3) 31 (if (>= current-depth 2) 17 10))))))))))
        (if (= opcode 44)
          (if (>= current-depth 12) 136 (if (>= current-depth 11) 122 (if (>= current-depth 10) 108 (if (>= current-depth 9) 94 (if (>= current-depth 8) 80 (if (>= current-depth 7) 66 (if (>= current-depth 6) 52 (if (>= current-depth 5) 38 (if (>= current-depth 4) 24 (if (>= current-depth 3) 10 3))))))))))
...
(defn native-function-size-x86 [func-meta function-metas]
  (let [param-count (native-function-param-count func-meta)
    ...
    param-spill-bytes (if (= param-count 12)
                        108
                        (if (= param-count 11)
                        97
                        (if (= param-count 10)
                       ...
                       (if (>= current-depth 3) 16 12)
                        (if (= target-param-count 1)
                          12
                           4)))))))))))))
    (if (= opcode 3)
      (if (>= current-depth 11) 84 (if (>= current-depth 10) 76 (if (>= current-depth 9) 68 (if (>= current-depth 8) 60 (if (>= current-depth 7) 52 (if (>= current-depth 6) 44 (if (>= current-depth 5) 36 (if (>= current-depth 4) 28 (if (>= current-depth 3) 20 (if (>= current-depth 2) 12 8))))))))))
      (if (= opcode 10)
        (if (>= current-depth 11) 84 (if (>= current-depth 10) 76 (if (>= current-depth 9) 68 (if (>= current-depth 8) 60 (if (>= current-depth 7) 52 (if (>= current-depth 6) 44 (if (>= current-depth 5) 36 (if (>= current-depth 4) 28 (if (>= current-depth 3) 20 (if (>= current-depth 2) 12 8))))))))))
        (if (= opcode 44)
          (if (>= current-depth 12) 80 (if (>= current-depth 11) 72 (if (>= current-depth 10) 64 (if (>= current-depth 9) 56 (if (>= current-depth 8) 48 (if (>= current-depth 7) 40 (if (>= current-depth 6) 32 (if (>= current-depth 5) 24 (if (>= current-depth 4) 16 (if (>= current-depth 3) 8 4))))))))))
