...
(defn emit-type-section-runtime []
  (let [b0 (emit-byte (vector-new 256) 5)
    b1 (emit-byte b0 96)
    b2 (emit-byte b1 1)
    b3 (emit-byte b2 126)
    b4 (emit-byte b3 1)
    ...
    b10 (emit-byte b9 96)
    b11 (emit-byte b10 2)
    b12 (emit-byte b11 126)
    b13 (emit-byte b12 126)
    b14 (emit-byte b13 1)
    b15 (emit-byte b14 126)
    b16 (emit-byte b15 96)
    b17 (emit-byte b16 3)
    b18 (emit-byte b17 126)
    b19 (emit-byte b18 126)
    b20 (emit-byte b19 126)
    b21 (emit-byte b20 1)
    b22 (emit-byte b21 126)
    b23 (emit-byte b22 96)
    b24 (emit-byte b23 0)
    b25 (emit-byte b24 1)
    b26 (emit-byte b25 126)
    body-size (vector-length b26)
    r0 (emit-byte (vector-new 32) 1)
    r1 (emit-leb128 r0 body-size)]
    (append-byte-vector r1 b26 0 body-size)))

(defn emit-import-section-runtime []
  (let [b0 (emit-byte (vector-new 256) 9)
    b1 (emit-byte b0 3)
    b2 (emit-byte b1 101)
    b3 (emit-byte b2 110)
    b4 (emit-byte b3 118)
    ...
    b8 (emit-byte b7 97)
    b9 (emit-byte b8 108)
    b10 (emit-byte b9 108)
    b11 (emit-byte b10 111)
    b12 (emit-byte b11 99)
    b13 (emit-byte b12 0)
    b14 (emit-byte b13 0)
    b15 (emit-byte b14 3)
    b16 (emit-byte b15 101)
    b17 (emit-byte b16 110)
    b18 (emit-byte b17 118)
    b19 (emit-byte b18 5)
    b20 (emit-byte b19 112)
    b21 (emit-byte b20 114)
    b22 (emit-byte b21 105)
    b23 (emit-byte b22 110)
    b24 (emit-byte b23 116)
    b25 (emit-byte b24 0)
    b26 (emit-byte b25 1)
    b27 (emit-byte b26 3)
    b28 (emit-byte b27 101)
    b29 (emit-byte b28 110)
    b30 (emit-byte b29 118)
    b31 (emit-byte b30 9)
    b32 (emit-byte b31 114)
    b33 (emit-byte b32 101)
    b34 (emit-byte b33 97)
    b35 (emit-byte b34 100)
    b36 (emit-byte b35 45)
    b37 (emit-byte b36 102)
    b38 (emit-byte b37 105)
    b39 (emit-byte b38 108)
    b40 (emit-byte b39 101)
    b41 (emit-byte b40 0)
    b42 (emit-byte b41 0)
    b43 (emit-byte b42 3)
    b44 (emit-byte b43 101)
    b45 (emit-byte b44 110)
    b46 (emit-byte b45 118)
    b47 (emit-byte b46 16)
    b48 (emit-byte b47 99)
    b49 (emit-byte b48 111)
    b50 (emit-byte b49 109)
    b51 (emit-byte b50 109)
    b52 (emit-byte b51 97)
    b53 (emit-byte b52 110)
    b54 (emit-byte b53 100)
    b55 (emit-byte b54 45)
    b56 (emit-byte b55 108)
    b57 (emit-byte b56 105)
    b58 (emit-byte b57 110)
    b59 (emit-byte b58 101)
    b60 (emit-byte b59 45)
    b61 (emit-byte b60 97)
    b62 (emit-byte b61 114)
    b63 (emit-byte b62 103)
    b64 (emit-byte b63 0)
    b65 (emit-byte b64 0)
    b66 (emit-byte b65 3)
    b67 (emit-byte b66 101)
    b68 (emit-byte b67 110)
    b69 (emit-byte b68 118)
    b70 (emit-byte b69 13)
    b71 (emit-byte b70 115)
    b72 (emit-byte b71 116)
    b73 (emit-byte b72 114)
    b74 (emit-byte b73 105)
    b75 (emit-byte b74 110)
    b76 (emit-byte b75 103)
    b77 (emit-byte b76 45)
    b78 (emit-byte b77 99)
    b79 (emit-byte b78 111)
    b80 (emit-byte b79 110)
    b81 (emit-byte b80 99)
    b82 (emit-byte b81 97)
    b83 (emit-byte b82 116)
    b84 (emit-byte b83 0)
    b85 (emit-byte b84 2)
    b86 (emit-byte b85 3)
    b87 (emit-byte b86 101)
    b88 (emit-byte b87 110)
    b89 (emit-byte b88 118)
    b90 (emit-byte b89 9)
    b91 (emit-byte b90 115)
    b92 (emit-byte b91 117)
    b93 (emit-byte b92 98)
    b94 (emit-byte b93 115)
    b95 (emit-byte b94 116)
    b96 (emit-byte b95 114)
    b97 (emit-byte b96 105)
    b98 (emit-byte b97 110)
    b99 (emit-byte b98 103)
    b100 (emit-byte b99 0)
    b101 (emit-byte b100 3)
    b102 (emit-byte b101 3)
    b103 (emit-byte b102 101)
    b104 (emit-byte b103 110)
    b105 (emit-byte b104 118)
    b106 (emit-byte b105 12)
    b107 (emit-byte b106 102)
    b108 (emit-byte b107 105)
    b109 (emit-byte b108 108)
    b110 (emit-byte b109 101)
    b111 (emit-byte b110 45)
    b112 (emit-byte b111 101)
    b113 (emit-byte b112 120)
    b114 (emit-byte b113 105)
    b115 (emit-byte b114 115)
    b116 (emit-byte b115 116)
    b117 (emit-byte b116 115)
    b118 (emit-byte b117 63)
    b119 (emit-byte b118 0)
    b120 (emit-byte b119 0)
    b121 (emit-byte b120 3)
    b122 (emit-byte b121 101)
    b123 (emit-byte b122 110)
    b124 (emit-byte b123 118)
    b125 (emit-byte b124 9)
    b126 (emit-byte b125 114)
    b127 (emit-byte b126 111)
    b128 (emit-byte b127 111)
    b129 (emit-byte b128 116)
    b130 (emit-byte b129 95)
    b131 (emit-byte b130 112)
    b132 (emit-byte b131 117)
    b133 (emit-byte b132 115)
    b134 (emit-byte b133 104)
    b135 (emit-byte b134 0)
    b136 (emit-byte b135 0)
    b137 (emit-byte b136 3)
    b138 (emit-byte b137 101)
    b139 (emit-byte b138 110)
    b140 (emit-byte b139 118)
    b141 (emit-byte b140 8)
    b142 (emit-byte b141 114)
    b143 (emit-byte b142 111)
    b144 (emit-byte b143 111)
    b145 (emit-byte b144 116)
    b146 (emit-byte b145 95)
    b147 (emit-byte b146 112)
    b148 (emit-byte b147 111)
    b149 (emit-byte b148 112)
    b150 (emit-byte b149 0)
    b151 (emit-byte b150 4)
    body-size (vector-length b151)
    r0 (emit-byte (vector-new 32) 2)
    r1 (emit-leb128 r0 body-size)]
    (append-byte-vector r1 b151 0 body-size)))
...
(defn emit-map-new-instr [bytes operand] (let [addr-idx (- operand 1) b1 (emit-leb128-s (emit-byte bytes 66) 32784) b2 (emit-leb128 (emit-byte b1 16) 0) b3 (emit-leb128 (emit-byte b2 33) addr-idx) b4 (emit-leb128 (emit-byte b3 32) addr-idx) b5 (emit-byte b4 167) b6 (emit-leb128 (emit-byte b5 65) 6) b7 (emit-byte b6 54) b8 (emit-byte b7 0) b9 (emit-byte b8 0) b10 (emit-leb128 (emit-byte b9 32) addr-idx) b11 (emit-byte b10 167) b12 (emit-leb128 (emit-byte b11 65) 2048) b13 (emit-byte b12 54) b14 (emit-byte b13 0) b15 (emit-byte b14 4) b16 (emit-leb128 (emit-byte b15 32) addr-idx) b17 (emit-byte b16 167) b18 (emit-leb128 (emit-byte b17 65) 0) b19 (emit-byte b18 54) b20 (emit-byte b19 0) b21 (emit-byte b20 8) b22 (emit-leb128 (emit-byte b21 32) addr-idx) b23 (emit-byte b22 167) b24 (emit-leb128 (emit-byte b23 65) 16) b25 (emit-byte b24 106) b26 (emit-leb128 (emit-byte b25 65) 0) b27 (emit-leb128 (emit-byte b26 65) 32768) b28 (emit-memory-fill b27) b29 (emit-leb128 (emit-byte b28 32) addr-idx) b30 (emit-tagged-pointer-high-bit b29)] (emit-byte b30 124)))
