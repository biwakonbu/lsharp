...
(defn emit-standalone-read-file-body []
  ;; 固定 256-byte read の bounded slice。root stack 後方の 2176/2184/2240 scratch を使う。
  (let [b0a (emit-standalone-byte-seq-2 (vector-new 512) 1 6)
    ...
    b3 (emit-standalone-byte-seq-8 b2 65 192 17 173 16 1 167 33)
    ...
    b14 (emit-standalone-byte-seq-8 b13 65 128 17 65 128 2 54 2)
...
(defn emit-standalone-write-file-body []
  ;; create|truncate + single fd_write の bounded slice。root stack 後方の 2176/2184/2240 scratch を使う。
  (let [b0a (emit-standalone-byte-seq-2 (vector-new 512) 1 7)
    ...
    b14 (emit-standalone-byte-seq-8 b13 40 2 0 33 7 65 128 17)
    b15 (emit-standalone-byte-seq-8 b14 32 4 54 2 0 65 128 17)
    b16 (emit-standalone-byte-seq-8 b15 32 5 54 2 4 65 136 17)
    b17 (emit-standalone-byte-seq-8 b16 65 0 54 2 0 32 7 65)
    b18 (emit-standalone-byte-seq-8 b17 128 17 65 1 65 136 17 16)
    b19 (emit-standalone-byte-seq-8 b18 0 26 65 136 17 40 2 0)
