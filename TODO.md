...
非実行、生成 route の `docs/api.json` 非作成を native MCP 33 tests と native LSP relay 5 tests、Rust `mcp_server::tests` 87 tests
...
completion/definition/references、package-install semantics、残る compile-run/provider semantics、target runtime、manifest runtime validation
