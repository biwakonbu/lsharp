...
sequence continuity verified partial sliceであり、既存の sequence required/positive/duplicate/rollback、完全な transition matrix/reducer、Rust/native reducer parity、
