...
2026-08-01 に native MCP の lsharp_errors、lsharp_search、lsharp_project_context を追加した。canonical
...
native MCP 21 tests と Rust MCP focused 59 tests で確認した verified partial である。残る LSP/package API/
compile-run/provider semantics、target runtime、manifest runtime validation
