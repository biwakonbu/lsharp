...
#[path = "wasmgc_runner_component_output.rs"]
mod component_output;

pub use component_output::{
    ...
    run_wasm_wasmgc_component_output_capture, run_wasm_wasmgc_component_output_component_capture,
    ...
    run_wasm_wasmgc_component_output_component_with_stdout_sink,
    run_wasm_wasmgc_component_output_to_fd_write, run_wasm_wasmgc_component_output_to_writer,
    run_wasm_wasmgc_component_output_with_stdout_sink, run_wasm_wasmgc_to_writer,
};
