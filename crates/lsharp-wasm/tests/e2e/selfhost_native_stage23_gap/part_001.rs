...
fn test_native_codegen_int_to_string_helpers_emit_tagged_decimal_string_abi() {
    ...
    assert_eq!(
        lines,
        vec![
            160, 65, 86, 83, 72, 137, 251, 77, 139, 22, 77, 133, 210, 117, 7, 73, 199, 194, 0, 32, 0,
            243, 164, 76, 137, 208, 72, 15, 186, 232, 63, 91, 65, 94, 195, 49, 192, 91, 65, 94, 195,
            176, 243, 83, 190, 169, 254, 11, 0, 249, 230, 3, 0, 170, 0, 4, 128, 210, 75, 253,
...
fn test_native_codegen_x86_string_slice_concat_helper_emitters_return_executable_byte_vectors() {
    ...
    assert_eq!(
        lines,
        vec![
            147, 83, 65, 84, 65, 85, 65, 86, 65, 65, 94, 65, 93, 65, 92, 91, 195, 197, 72, 133,
